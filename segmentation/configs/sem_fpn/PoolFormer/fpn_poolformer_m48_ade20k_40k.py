...
model = dict(
    type='EncoderDecoder',
    # pretrained='https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_m48.pth.tar', # for old version of mmsegmentation 
    backbone=dict(
        type='poolformer_m48_feat',
        style='pytorch',
        init_cfg=dict(
            type='Pretrained', 
            checkpoint=\
